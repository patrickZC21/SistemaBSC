...
export const crearAlmacen = async (req, res) => {
  ...
  try {
    ...
    notificationService.notifyDashboardUpdate('almacen', 'create');
...
export const actualizarAlmacen = async (req, res) => {
  ...
  try {
    ...
    // Notificar dashboard en tiempo real
    notificationService.notifyDashboardUpdate('almacen', 'update');
...
export const eliminarAlmacen = async (req, res) => {
  try {
    ...
    if (affectedRows === 0) return res.status(404).json({ error: 'Almacén no encontrado' });
    // Notificar dashboard en tiempo real
    notificationService.notifyDashboardUpdate('almacen', 'delete');
    // Devuelve mensaje de éxito
