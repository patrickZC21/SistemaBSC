...
export const crearTrabajador = async (req, res) => {
  ...
  try {
    ...
    notificationService.notifyDashboardUpdate('trabajador', 'create');
...
export const actualizarTrabajador = async (req, res) => {
  ...
  try {
    ...
    if (affectedRows === 0)
      return res.status(404).json({ error: 'Trabajador no encontrado' });
    notificationService.notifyDashboardUpdate('trabajador', 'update');
...
export const eliminarTrabajador = async (req, res) => {
  try {
    ...
    if (affectedRows === 0)
      return res.status(404).json({ error: 'Trabajador no encontrado' });
    notificationService.notifyDashboardUpdate('trabajador', 'delete');
...
export const actualizarEstadoTrabajador = async (req, res) => {
  ...
  try {
    ...
    notificationService.notifyDashboardUpdate('trabajador', 'status_change');
