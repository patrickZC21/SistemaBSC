...
import { obtenerMetricasTarjetas } from '../controllers/dashboard/metricasTarjetas.controller.js';
...
router.get('/metricas-tarjetas', verificarToken, obtenerMetricasTarjetas);
